...
public interface IWorkshopRepository : IGenericRepository<Workshop>
{
    ...
    Task<(IReadOnlyList<Workshop> Items, int TotalCount)> GetPaginatedAsync(int pageNumber, int pageSize, CancellationToken ct, double? minRating = null, string? search = null, WorkshopType? type = null);
}
